	...
	public class YoutubeConnector {
		...
		private YouTube.Captions.Download query1;
		...
		public static final String KEY = "AIzaSyChj2Nr7C9h8MDy08pJQKhULMaxpjOYeyo";

	    //Package name of the app that will call the YouTube Data API
		public static final String PACKAGENAME = "com.free.music.downloader";

	    //SHA1 fingerprint of APP can be found by double clicking on the app signing report on right tab called gradle
		public static final String SHA1 = "9C:A7:67:86:C5:78:A1:77:EC:E4:BE:BB:83:8B:92:D1:C5:CC:9E:FC";
		...
		public YoutubeConnector(Context context) {
			...
			youtube = new YouTube.Builder(new NetHttpTransport(), new JacksonFactory(), credential).setYouTubeRequestInitializer(new YouTubeRequestInitializer(KEY)).setApplicationName("Some Name").build();
